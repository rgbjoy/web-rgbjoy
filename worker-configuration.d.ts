/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example` (hash: 164c0fd5cf3764cf47cd75ace3f16c71)
// Runtime types generated with workerd@1.20260921.1 2026-09-21 nodejs_compat
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	DASHBOARD_LOGIN_LIMIT: RateLimit;
	ASSETS: Fetcher;
	MEDIA_PUBLIC_URL: "https://web-rgbjoy.tom-a2d.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MEDIA_PUBLIC_URL" | "DASHBOARD_PASSWORD_HASH" | "DASHBOARD_SESSION_SECRET" | "S3_ACCESS_KEY_ID" | "S3_SECRET_ACCESS_KEY" | "S3_REGION" | "S3_BUCKET" | "CONTACT_FROM">> {}
}
