...
export const posts = pgTable('posts', {
  ...
  _status: enum_posts_status('_status').default("draft"),
    ...
    index('posts_featured_image_idx').on(columns.featuredImage), uniqueIndex('posts_slug_idx').on(columns.slug), index('posts_updated_at_idx').on(columns.updatedAt), index('posts_created_at_idx').on(columns.createdAt), index('posts__status_idx').on(columns._status),
]
)
...
export const _posts_v = pgTable('_posts_v', {
  ...
  autosave: boolean('autosave'),
    ...
    index('_posts_v_parent_idx').on(columns.parent), index('_posts_v_version_version_featured_image_idx').on(columns.version_featuredImage), index('_posts_v_version_version_slug_idx').on(columns.version_slug), index('_posts_v_version_version_updated_at_idx').on(columns.version_updatedAt), index('_posts_v_version_version_created_at_idx').on(columns.version_createdAt), index('_posts_v_version_version__status_idx').on(columns.version__status), index('_posts_v_created_at_idx').on(columns.createdAt), index('_posts_v_updated_at_idx').on(columns.updatedAt), index('_posts_v_latest_idx').on(columns.latest), index('_posts_v_autosave_idx').on(columns.autosave),
]
)
...
export const redirects_rels = pgTable('redirects_rels', {
  ...
  postsID: integer('posts_id'),
    ...
    index('redirects_rels_order_idx').on(columns.order), index('redirects_rels_parent_idx').on(columns.parent), index('redirects_rels_path_idx').on(columns.path), index('redirects_rels_posts_id_idx').on(columns.postsID), foreignKey({
...
export const payload_locked_documents_rels = pgTable('payload_locked_documents_rels', {
  ...
  redirectsID: integer('redirects_id'),
    ...
    index('payload_locked_documents_rels_order_idx').on(columns.order), index('payload_locked_documents_rels_parent_idx').on(columns.parent), index('payload_locked_documents_rels_path_idx').on(columns.path), index('payload_locked_documents_rels_users_id_idx').on(columns.usersID), index('payload_locked_documents_rels_media_id_idx').on(columns.mediaID), index('payload_locked_documents_rels_posts_id_idx').on(columns.postsID), index('payload_locked_documents_rels_redirects_id_idx').on(columns.redirectsID), foreignKey({
      columns: [columns['parent']],
...
export const info_links = pgTable('info_links', {
  _order: integer('_order').notNull(),
  _parentID: integer('_parent_id').notNull(),
  id: varchar('id').primaryKey(),
  ...
  link_url: varchar('link_url').notNull(),
    ...
    index('info_links_order_idx').on(columns._order), index('info_links_parent_id_idx').on(columns._parentID), foreignKey({
      columns: [columns['_parentID']],
...
export const info = pgTable('info', {
  ...
  createdAt: timestamp('created_at', {mode: 'string',withTimezone: true,precision: 3}),
    ...
    index('info_profile_image_idx').on(columns.profileImage), index('info_resume_idx').on(columns.resume),
]
)


export const dev_past_projects = pgTable('dev_past_projects', {
  _order: integer('_order').notNull(),
  _parentID: integer('_parent_id').notNull(),
  id: varchar('id').primaryKey(),
  ...
  description: varchar('description'),
    ...
    index('dev_past_projects_order_idx').on(columns._order), index('dev_past_projects_parent_id_idx').on(columns._parentID), index('dev_past_projects_image_idx').on(columns.image), foreignKey({
      columns: [columns['_parentID']],
...
export const art_gallery = pgTable('art_gallery', {
  _order: integer('_order').notNull(),
  _parentID: integer('_parent_id').notNull(),
  id: varchar('id').primaryKey(),
  ...
  description: varchar('description'),
    ...
    index('art_gallery_order_idx').on(columns._order), index('art_gallery_parent_id_idx').on(columns._parentID), index('art_gallery_image_idx').on(columns.image), foreignKey({
      columns: [columns['_parentID']],
...
export const footer_links = pgTable('footer_links', {
  ...
  link: varchar('link'),
    ...
    index('footer_links_order_idx').on(columns._order), index('footer_links_parent_id_idx').on(columns._parentID), foreignKey({
      columns: [columns['_parentID']],
