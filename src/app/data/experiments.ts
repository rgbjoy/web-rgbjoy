...
export const EXPERIMENTS: Experiment[] = [
  ...
  },
  {
    ...
    title: "Glass Lines",
    description: "Refracted line-field glass lighting by SamuelYAN.",
    group: "Glass & Refraction",
    date: "2026-06",
    status: "live",
  ...
  {
    href: "/experiments/prismatic-cells",
    title: "Prismatic Cells",
    description: "RGB warped cell glow by Danilo Guanabara.",
    group: "Generative & Visual",
    date: "2026-06",
    status: "live",
    keywords: ["prismatic", "cells", "warp", "guanabara", "shader"],
  },
  {
